        ...
        <div class="row">
          <div class="col-8 mx-auto text-center mt-1">
            <p class="mb-0 text-secondary">
              ...
              <a style="color: #252f40;" href="#" class="font-weight-bold ml-1" target="_blank">Sm4rtbuy</a>
              /
              <a style="color: #252f40;" href="#" class="font-weight-bold ml-1" target="_blank">Group 4</a>.
            </p>
          </div>
        </div>
      @endif
