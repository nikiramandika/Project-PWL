      ...
      <div class="col-lg-8 mb-4 mx-auto text-center">
        ...
        @if (!auth()->user() || \Request::is('static-sign-up')) 
          <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
              ...
              <a href="https://github.com/nikiramandika/Project-PPWL" target="_blank" class="text-secondary me-xl-4 me-4">
        ...
        <div class="row">
          <div class="col-8 mx-auto text-center mt-1">
            <p class="mb-0 text-secondary">
              ...
              <a style="color: #252f40;" href="#" class="font-weight-bold ml-1" target="_blank">TIM PPWL ANJAY</a>
              &
              <a style="color: #252f40;" href="#" class="font-weight-bold ml-1" target="_blank">BIKIN LA WE NAMANYA</a>.
            </p>
          </div>
        </div>
      @endif
