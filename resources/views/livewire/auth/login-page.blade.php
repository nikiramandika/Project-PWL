          ...
          <div class="p-4 sm:p-7">
            <div class="text-center">
              ...
              <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <a class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/register-user">
                  Sign up here
                </a>
              </p>
            </div>
              ...
              <div class="grid gap-y-4">
                ...
                <div>
                  <div class="flex justify-between items-center">
                    ...
                    <a class="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/forgot-user">Forgot password?</a>
                  </div>
                  <div class="relative">
