    ...
    <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
      <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
        ...
        <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ asset($product->image) }}' }">
            ...
            <div class="lg:pl-20">
              ...
              <div class="w-32 mb-8 ">
                ...
                <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                  ...
                  <input type="number" /*wire:model='quantity'*/ readonly class="flex items-center w-full font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-300 outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-900 focus:outline-none text-md hover:text-black" placeholder="{!!$quantity!!}"></input>
