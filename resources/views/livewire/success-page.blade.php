        ...
        <div>
            ...
            <div class="flex items-start justify-start flex-shrink-0">
                ...
                <div class="flex flex-col items-start justify-start space-y-2">
                    ...
                    <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{ $order->address->city }}, {{ $order->address->state }}, {{ $order->address->zip_code}}
            ...
            <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
                <a href="/my-orders" class="w-full text-center px-4 py-2 bg-blue-500 rounded-full text-gray-50 md:w-auto dark:text-gray-300 hover:bg-blue-600 dark:hover:bg-gray-700 dark:bg-gray-800">
                    View My Orders
                </a>
            <a href="/products" class="w-full text-center px-4 py-2 text-blue-500 border border-blue-500 rounded-full md:w-auto hover:text-white hover:bg-blue-600 dark:border-gray-700 dark:hover:bg-gray-700 dark:text-gray-300">
                Go back shopping
            </a>
