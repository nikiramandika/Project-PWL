        ...
        <div class="md:w-3/4">
                    ...
                    <tbody>
                        ...
                        @foreach ($order_items as $item)
                            <tr wire:key="{{ $item->id }}">
                                ...
                                <td class="py-4">
                                    <span class="text-center w-8">{{ $item['product']->name }}</span>
                                </td>
            ...
            <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <p> {{ $address->street_address ?? 'gaada alamat' }}, {{ $address->city ?? 'gaada kota' }},
                            {{ $address->state ?? 'gaada kabupaten' }}, {{ $address->zip_code ?? 'gaada kodepos' }}
                        </p>
                    </div>
                    <div>
