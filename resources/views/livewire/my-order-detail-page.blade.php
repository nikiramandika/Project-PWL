        ...
        <div class="p-4 md:p-5 flex gap-x-4">
          ...
          <div class="grow">
            ...
            <div class="mt-1 flex items-center gap-x-2">
              <div> {{ $address->full_name ?? 'Tidak Ada Nama'}} </div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="md:w-3/4">
              ...
              <tr wire:key="{{ $item->id }}">
                <td class="py-4">
                  <div class="flex items-center">
                    ...
                    @else
                    <img class="h-16 w-16 mr-4" src="{{ url('storage/default-image.jpg') }}" alt="Default Image">
                    @endif
        ...
        <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
          ...
          <div class="flex justify-between items-center">
            <div>
              <p> {{ $address->street_address ?? 'gaada alamat' }}, {{ $address->city ?? 'gaada kota' }}, {{ $address->state ?? 'gaada kabupaten' }}, {{ $address->zip_code ?? 'gaada kodepos' }} </p>
            </div>
            <div>
              <p class="font-semibold">Phone:</p>
              <p>{{ $address->phone ?? 'gaada no hp' }}</p>
            </div>
          </div>
        </div>
