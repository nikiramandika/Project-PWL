<div class="w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-white ">
    <div class="max-w-[85rem] px-4 py-6 sm:px-6 lg:px-8 lg:py-10 mx-auto lg:min-h-96">
      <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <a class="group flex flex-col bg-white border shadow-sm rounded-3xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="products?selected_categories[0]={{ $category->id }}">
          <div class="p-4 md:p-5">
            <div class="flex justify-between items-center">
              <div class="flex items-center">
                <img class="h-[5rem] w-[5rem] rounded-xl" src="{{ asset($category->image) }}" alt="Image Description">
                <div class="ms-3">
