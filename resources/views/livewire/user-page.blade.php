<div >
    ...
    <div class="flex w-full h-screen py-10 px-4 sm:px-6 lg:px-8 mx-auto backgroundimg justify-center">
        <div class="max-w-[85rem] m-auto px-4 sm:px-6 lg:px-8">
            <!-- Grid -->
            <div class="md:items-center text-center justify-center items-center">
                <div>
                    {{-- <h1
                    ...
                    <p class="mt-3 text-lg text-gray-400 dark:text-gray-400">Purchase wide varities of electronics
                        products</p>

                    <!-- Buttons -->
                    <div class="mt-7 w-full sm:inline-flex text-center items-center justify-around">
                        <a class="py-2 px-5 inline-flex justify-center items-center gap-x-2 text-sm font-semibold border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 rounded-full"
                            href="/products">
                            See our products
                        </a>
                    </div>
            ...
            {{-- <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                ...
                <div class="py-5">
                    <div class="flex space-x-1">
                        <svg class="h-4 w-4 text-gray-100 dark:text-gray-200" width="51" height="51"
