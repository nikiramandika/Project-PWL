        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between w-full">
                <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:ring-gray-600"
                    href="/" aria-label="Brand">Project PPWL</a>
                <div class="md:hidden">
                    <button type="button"
                    ...
                    <div
                        ...
                        @else
                            <div class="pt-3 md:pt-0">
                                <a class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:ring-gray-600"
                                    href="/login">
